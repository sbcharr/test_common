...
/*
Package api_v1_scheduler is a generated protocol buffer package.
...
import fmt "fmt"
import math "math"
import api_v1 "github.com/mesos/test_common/api/v1"
...
type Event struct {
	...
	Type                *Event_Type                `protobuf:"varint,1,opt,name=type,enum=api.v1.scheduler.Event_Type" json:"type,omitempty"`
...
type Event_Subscribed struct {
	FrameworkId *api_v1.FrameworkID `protobuf:"bytes,1,req,name=framework_id,json=frameworkId" json:"framework_id,omitempty"`
	...
	// Since Mesos 1.1.
	MasterInfo       *api_v1.MasterInfo `protobuf:"bytes,3,opt,name=master_info,json=masterInfo" json:"master_info,omitempty"`
	XXX_unrecognized []byte             `json:"-"`
}
...
func (m *Event_Subscribed) GetFrameworkId() *api_v1.FrameworkID {
	if m != nil {
...
func (m *Event_Subscribed) GetMasterInfo() *api_v1.MasterInfo {
	if m != nil {
		return m.MasterInfo
	}
	return nil
...
type Event_Offers struct {
	Offers           []*api_v1.Offer `protobuf:"bytes,1,rep,name=offers" json:"offers,omitempty"`
	XXX_unrecognized []byte          `json:"-"`
}
...
func (m *Event_Offers) GetOffers() []*api_v1.Offer {
	if m != nil {
		return m.Offers
	}
	return nil
...
type Event_InverseOffers struct {
	InverseOffers    []*api_v1.InverseOffer `protobuf:"bytes,1,rep,name=inverse_offers,json=inverseOffers" json:"inverse_offers,omitempty"`
	XXX_unrecognized []byte                 `json:"-"`
}
...
func (m *Event_InverseOffers) GetInverseOffers() []*api_v1.InverseOffer {
	if m != nil {
		return m.InverseOffers
	}
	return nil
...
type Event_Rescind struct {
	OfferId          *api_v1.OfferID `protobuf:"bytes,1,req,name=offer_id,json=offerId" json:"offer_id,omitempty"`
	XXX_unrecognized []byte          `json:"-"`
}
...
func (m *Event_Rescind) GetOfferId() *api_v1.OfferID {
	if m != nil {
		return m.OfferId
	}
	return nil
...
type Event_RescindInverseOffer struct {
	InverseOfferId   *api_v1.OfferID `protobuf:"bytes,1,req,name=inverse_offer_id,json=inverseOfferId" json:"inverse_offer_id,omitempty"`
	XXX_unrecognized []byte          `json:"-"`
}
...
func (m *Event_RescindInverseOffer) GetInverseOfferId() *api_v1.OfferID {
	if m != nil {
...
type Event_Update struct {
	Status           *api_v1.TaskStatus `protobuf:"bytes,1,req,name=status" json:"status,omitempty"`
	XXX_unrecognized []byte             `json:"-"`
}
...
func (m *Event_Update) GetStatus() *api_v1.TaskStatus {
	if m != nil {
		return m.Status
	}
	return nil
...
type Event_Message struct {
	AgentId          *api_v1.AgentID    `protobuf:"bytes,1,req,name=agent_id,json=agentId" json:"agent_id,omitempty"`
	ExecutorId       *api_v1.ExecutorID `protobuf:"bytes,2,req,name=executor_id,json=executorId" json:"executor_id,omitempty"`
...
func (m *Event_Message) GetAgentId() *api_v1.AgentID {
	if m != nil {
		return m.AgentId
	}
	return nil
...
func (m *Event_Message) GetExecutorId() *api_v1.ExecutorID {
	if m != nil {
		return m.ExecutorId
	}
	return nil
...
type Event_Failure struct {
	AgentId *api_v1.AgentID `protobuf:"bytes,1,opt,name=agent_id,json=agentId" json:"agent_id,omitempty"`
	// If this was just a failure of an executor on an agent then
	// 'executor_id' will be set and possibly 'status' (if we were
	// able to determine the exit status).
	ExecutorId *api_v1.ExecutorID `protobuf:"bytes,2,opt,name=executor_id,json=executorId" json:"executor_id,omitempty"`
...
func (m *Event_Failure) GetAgentId() *api_v1.AgentID {
	if m != nil {
		return m.AgentId
	}
	return nil
...
func (m *Event_Failure) GetExecutorId() *api_v1.ExecutorID {
	if m != nil {
		return m.ExecutorId
	}
	return nil
...
type Call struct {
	...
	// failovers, etc.
	FrameworkId *api_v1.FrameworkID `protobuf:"bytes,1,opt,name=framework_id,json=frameworkId" json:"framework_id,omitempty"`
	// Type of the call, indicates which optional field below should be
	// present if that type has a nested message definition.
	// See comments on `Event::Type` above on the reasoning behind this field being optional.
	Type                 *Call_Type                 `protobuf:"varint,2,opt,name=type,enum=api.v1.scheduler.Call_Type" json:"type,omitempty"`
...
func (m *Call) GetFrameworkId() *api_v1.FrameworkID {
	if m != nil {
		return m.FrameworkId
	}
	return nil
...
type Call_Subscribe struct {
	...
	// 'framework_info.id'.
	FrameworkInfo *api_v1.FrameworkInfo `protobuf:"bytes,1,req,name=framework_info,json=frameworkInfo" json:"framework_info,omitempty"`
...
func (m *Call_Subscribe) GetFrameworkInfo() *api_v1.FrameworkInfo {
	if m != nil {
...
type Call_Accept struct {
	OfferIds         []*api_v1.OfferID         `protobuf:"bytes,1,rep,name=offer_ids,json=offerIds" json:"offer_ids,omitempty"`
	Operations       []*api_v1.Offer_Operation `protobuf:"bytes,2,rep,name=operations" json:"operations,omitempty"`
	Filters          *api_v1.Filters           `protobuf:"bytes,3,opt,name=filters" json:"filters,omitempty"`
	XXX_unrecognized []byte                    `json:"-"`
}
...
func (m *Call_Accept) GetOfferIds() []*api_v1.OfferID {
	if m != nil {
		return m.OfferIds
	}
	return nil
...
func (m *Call_Accept) GetOperations() []*api_v1.Offer_Operation {
	if m != nil {
		return m.Operations
	}
	return nil
...
func (m *Call_Accept) GetFilters() *api_v1.Filters {
	if m != nil {
		return m.Filters
	}
	return nil
...
type Call_Decline struct {
	OfferIds         []*api_v1.OfferID `protobuf:"bytes,1,rep,name=offer_ids,json=offerIds" json:"offer_ids,omitempty"`
	Filters          *api_v1.Filters   `protobuf:"bytes,2,opt,name=filters" json:"filters,omitempty"`
	XXX_unrecognized []byte            `json:"-"`
}
...
func (m *Call_Decline) GetOfferIds() []*api_v1.OfferID {
	if m != nil {
		return m.OfferIds
	}
	return nil
...
func (m *Call_Decline) GetFilters() *api_v1.Filters {
	if m != nil {
		return m.Filters
	}
	return nil
...
type Call_AcceptInverseOffers struct {
	InverseOfferIds  []*api_v1.OfferID `protobuf:"bytes,1,rep,name=inverse_offer_ids,json=inverseOfferIds" json:"inverse_offer_ids,omitempty"`
	Filters          *api_v1.Filters   `protobuf:"bytes,2,opt,name=filters" json:"filters,omitempty"`
	XXX_unrecognized []byte            `json:"-"`
}
...
func (m *Call_AcceptInverseOffers) GetInverseOfferIds() []*api_v1.OfferID {
	if m != nil {
...
func (m *Call_AcceptInverseOffers) GetFilters() *api_v1.Filters {
	if m != nil {
		return m.Filters
	}
	return nil
...
func (m *Call_DeclineInverseOffers) GetInverseOfferIds() []*api_v1.OfferID {
	if m != nil {
		return m.InverseOfferIds
	}
	return nil
...
func (m *Call_DeclineInverseOffers) GetFilters() *api_v1.Filters {
	if m != nil {
		return m.Filters
	}
	return nil
...
type Call_Kill struct {
	TaskId  *api_v1.TaskID  `protobuf:"bytes,1,req,name=task_id,json=taskId" json:"task_id,omitempty"`
	AgentId *api_v1.AgentID `protobuf:"bytes,2,opt,name=agent_id,json=agentId" json:"agent_id,omitempty"`
	...
	KillPolicy       *api_v1.KillPolicy `protobuf:"bytes,3,opt,name=kill_policy,json=killPolicy" json:"kill_policy,omitempty"`
	XXX_unrecognized []byte             `json:"-"`
}
...
func (m *Call_Kill) GetTaskId() *api_v1.TaskID {
	if m != nil {
		return m.TaskId
	}
	return nil
...
func (m *Call_Kill) GetAgentId() *api_v1.AgentID {
	if m != nil {
		return m.AgentId
	}
	return nil
...
func (m *Call_Kill) GetKillPolicy() *api_v1.KillPolicy {
	if m != nil {
		return m.KillPolicy
	}
	return nil
...
type Call_Shutdown struct {
	ExecutorId       *api_v1.ExecutorID `protobuf:"bytes,1,req,name=executor_id,json=executorId" json:"executor_id,omitempty"`
	AgentId          *api_v1.AgentID    `protobuf:"bytes,2,req,name=agent_id,json=agentId" json:"agent_id,omitempty"`
	XXX_unrecognized []byte             `json:"-"`
}
...
func (m *Call_Shutdown) GetExecutorId() *api_v1.ExecutorID {
	if m != nil {
		return m.ExecutorId
	}
	return nil
...
func (m *Call_Shutdown) GetAgentId() *api_v1.AgentID {
	if m != nil {
		return m.AgentId
	}
	return nil
...
type Call_Acknowledge struct {
	AgentId          *api_v1.AgentID `protobuf:"bytes,1,req,name=agent_id,json=agentId" json:"agent_id,omitempty"`
	TaskId           *api_v1.TaskID  `protobuf:"bytes,2,req,name=task_id,json=taskId" json:"task_id,omitempty"`
...
func (m *Call_Acknowledge) GetAgentId() *api_v1.AgentID {
	if m != nil {
		return m.AgentId
	}
	return nil
...
func (m *Call_Acknowledge) GetTaskId() *api_v1.TaskID {
	if m != nil {
		return m.TaskId
	}
	return nil
...
func (m *Call_Reconcile_Task) GetTaskId() *api_v1.TaskID {
	if m != nil {
		return m.TaskId
	}
	return nil
...
func (m *Call_Reconcile_Task) GetAgentId() *api_v1.AgentID {
	if m != nil {
		return m.AgentId
	}
	return nil
...
func (m *Call_Message) GetAgentId() *api_v1.AgentID {
	if m != nil {
		return m.AgentId
	}
	return nil
...
func (m *Call_Message) GetExecutorId() *api_v1.ExecutorID {
	if m != nil {
		return m.ExecutorId
	}
	return nil
...
type Call_Request struct {
	Requests         []*api_v1.Request `protobuf:"bytes,1,rep,name=requests" json:"requests,omitempty"`
	XXX_unrecognized []byte            `json:"-"`
}
...
func (m *Call_Request) GetRequests() []*api_v1.Request {
	if m != nil {
		return m.Requests
	}
	return nil
...
func init() {
	proto.RegisterType((*Event)(nil), "api.v1.scheduler.Event")
	proto.RegisterType((*Event_Subscribed)(nil), "api.v1.scheduler.Event.Subscribed")
	proto.RegisterType((*Event_Offers)(nil), "api.v1.scheduler.Event.Offers")
	proto.RegisterType((*Event_InverseOffers)(nil), "api.v1.scheduler.Event.InverseOffers")
	proto.RegisterType((*Event_Rescind)(nil), "api.v1.scheduler.Event.Rescind")
	proto.RegisterType((*Event_RescindInverseOffer)(nil), "api.v1.scheduler.Event.RescindInverseOffer")
	proto.RegisterType((*Event_Update)(nil), "api.v1.scheduler.Event.Update")
	proto.RegisterType((*Event_Message)(nil), "api.v1.scheduler.Event.Message")
	proto.RegisterType((*Event_Failure)(nil), "api.v1.scheduler.Event.Failure")
	proto.RegisterType((*Event_Error)(nil), "api.v1.scheduler.Event.Error")
	proto.RegisterType((*Call)(nil), "api.v1.scheduler.Call")
	proto.RegisterType((*Call_Subscribe)(nil), "api.v1.scheduler.Call.Subscribe")
	proto.RegisterType((*Call_Accept)(nil), "api.v1.scheduler.Call.Accept")
	proto.RegisterType((*Call_Decline)(nil), "api.v1.scheduler.Call.Decline")
	proto.RegisterType((*Call_AcceptInverseOffers)(nil), "api.v1.scheduler.Call.AcceptInverseOffers")
	proto.RegisterType((*Call_DeclineInverseOffers)(nil), "api.v1.scheduler.Call.DeclineInverseOffers")
	proto.RegisterType((*Call_Revive)(nil), "api.v1.scheduler.Call.Revive")
	proto.RegisterType((*Call_Kill)(nil), "api.v1.scheduler.Call.Kill")
	proto.RegisterType((*Call_Shutdown)(nil), "api.v1.scheduler.Call.Shutdown")
	proto.RegisterType((*Call_Acknowledge)(nil), "api.v1.scheduler.Call.Acknowledge")
	proto.RegisterType((*Call_Reconcile)(nil), "api.v1.scheduler.Call.Reconcile")
	proto.RegisterType((*Call_Reconcile_Task)(nil), "api.v1.scheduler.Call.Reconcile.Task")
	proto.RegisterType((*Call_Message)(nil), "api.v1.scheduler.Call.Message")
	proto.RegisterType((*Call_Request)(nil), "api.v1.scheduler.Call.Request")
	proto.RegisterType((*Call_Suppress)(nil), "api.v1.scheduler.Call.Suppress")
	proto.RegisterEnum("api.v1.scheduler.Event_Type", Event_Type_name, Event_Type_value)
	proto.RegisterEnum("api.v1.scheduler.Call_Type", Call_Type_name, Call_Type_value)
}
...
var fileDescriptor0 = []byte{
	...
	,
}
